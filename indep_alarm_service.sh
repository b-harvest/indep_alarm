cd /home/ubuntu/indep_alarm;echo "[Unit]
Description=indep_alarm
After=network-online.target
[Service]
User=ubuntu
WorkingDirectory=/home/ubuntu/indep_alarm
ExecStart=/usr/bin/python3 /home/ubuntu/indep_alarm/indep_alarm.py
...
User=ubuntu
WorkingDirectory=/home/ubuntu/indep_alarm
ExecStart=/usr/bin/python3 /home/ubuntu/indep_alarm/indep_alarm_check.py
